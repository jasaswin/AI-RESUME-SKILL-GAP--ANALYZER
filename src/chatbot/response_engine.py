...
class ResponseEngine:
    """
    LLM-powered response engine (non-rule-based)
    """
...
STRICT RULES:
- Answer ONLY based on the provided analysis
- Do NOT ask follow-up questions
- Do NOT act like a general chatbot
- Be direct, clear, and to the point
- If user asks for roadmap → give step-by-step roadmap
- If user asks "where to learn" → suggest platforms/resources
- If user asks "why" → explain using analysis data
...
"""
        ...
        # ✅ Call LLM properly
        response = self.formatter.llm.generate(prompt)
